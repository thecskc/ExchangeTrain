...
/* harmony import */ var _components_Loader__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../components/Loader */ "./components/Loader.js");
/* harmony import */ var valid_url__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! valid-url */ "./node_modules/valid-url/index.js");
/* harmony import */ var valid_url__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(valid_url__WEBPACK_IMPORTED_MODULE_16__);
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_7__["default"])(Profile, _Component);
  ...
  function Profile(props) {
    ...
    _this.loadedProfile = _this.loadedProfile.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this));
    _this.editProfile = _this.editProfile.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this));
    _this.handleAccessCode = _this.handleAccessCode.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this));
    _this.cutWords = _this.cutWords.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this));
    return _this;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Profile, [{
    ...
    value: function cutWords(strVal) {
      ...
      if (resultArray.length > 100) {
        resultArray = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_1__["default"])("resultArray"), resultArray.slice(0, 100));
        result = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_1__["default"])("result"), resultArray.join(" ") + "...");
      }
    ...
    value: function validateForm() {
      ...
      if (!this.state.resume) {
        ...
        if (!Object(valid_url__WEBPACK_IMPORTED_MODULE_16__["isWebUri"])(this.state.resume)) {
    ...
    value: function editProfile(event) {
      ...
      if (this.validateForm()) {
        ...
        var dbRef = _components_firebase__WEBPACK_IMPORTED_MODULE_9__["default"].firestore().collection("Profiles").doc(this.state.user.uid).set(this.settingData()).then(function () {
          console.log("written");
          var userProfile = {
    ...
    value: function getUserProfile(user) {
      ...
      var db = _components_firebase__WEBPACK_IMPORTED_MODULE_9__["default"].firestore();
    ...
    value: function render() {
      ...
      if (this.state.loaded) {
        if (this.state.user) {
          return __jsx(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, null, __jsx(_components_navbar__WEBPACK_IMPORTED_MODULE_14__["default"], {
            ...
            if (_this5.state.isCoach) {
              return __jsx(_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_11__["default"], {
                name: "calendlylink",
        ...
        return __jsx(_components_Loader__WEBPACK_IMPORTED_MODULE_15__["default"], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 382
          },
...
//# sourceMappingURL=profile.js.f30aa9778c6bfe0cbb12.hot-update.js.map