...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _firebase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./firebase */ "./components/firebase.js");
/* harmony import */ var _styling_style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../styling/style.css */ "./styling/style.css");
/* harmony import */ var _styling_style_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_styling_style_css__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_Coach__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/Coach */ "./components/Coach.js");
/* harmony import */ var _material_ui_core_Button_Button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @material-ui/core/Button/Button */ "@material-ui/core/Button/Button");
/* harmony import */ var _material_ui_core_Button_Button__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core_Button_Button__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! next/router */ "next/router");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _DialogComp__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DialogComp */ "./components/DialogComp.js");
...
class CoachConnectionRequests extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    this.state = {
      "cards": [],
  ...
  handleClick(event, status, userDoc) {
    ...
    if (status === "USER_CALL_REQUEST") {
      ...
      const fb = _firebase__WEBPACK_IMPORTED_MODULE_1__["default"].firestore().collection("Connections").doc(userID + "_" + coachID).set({
  ...
  async getDoc(userList) {
    for (let i = 0; i < userList.length; i++) {
      const doc = await _firebase__WEBPACK_IMPORTED_MODULE_1__["default"].firestore().collection("Profiles").doc(userList[i].user).get();
  ...
  componentDidMount() {
    let userList = [];
    const callReqRef = _firebase__WEBPACK_IMPORTED_MODULE_1__["default"].firestore().collection("Connections").where("coach", "==", this.props.user.uid).get().then(snapShot => {
  ...
  makeCard(heading, subheading, status, paragraph, userDoc) {
    let button = __jsx("button", {
      className: "coach-button",
      onClick: event => this.handleClick(event, status, userDoc),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 159
      },
    ...
    return __jsx("div", {
      ...
      __self: this
    }), __jsx(_material_ui_core_Button_Button__WEBPACK_IMPORTED_MODULE_4___default.a, {
      color: "primary",
      onClick: event => {
  ...
  render() {
    let dialog = __jsx(_DialogComp__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    if (this.state.loaded) {
      if (!this.state.noConnections) {
        return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, dialog, this.state.cards);
      } else {
...
var _jsxFileName = "C:\\Users\\santh\\WebstormProjects\\ExchangeTrain\\components\\DialogComp.js";
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
class DialogComp extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
  }

  render() {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_material_ui_core_Dialog__WEBPACK_IMPORTED_MODULE_4___default.a, {
      ...
      __self: this
    }, this.props.title, " "), __jsx(_material_ui_core_DialogContent__WEBPACK_IMPORTED_MODULE_6___default.a, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 21
      },
      __self: this
    }, __jsx(_material_ui_core_DialogContentText__WEBPACK_IMPORTED_MODULE_7___default.a, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 22
      },
...
/* harmony default export */ __webpack_exports__["default"] = (DialogComp);
...
class UserConnectionRequests extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    this.state = {
      "cards": [],
  ...
  async getDoc(coachesList) {
    for (let i = 0; i < coachesList.length; i++) {
      const doc = await _firebase__WEBPACK_IMPORTED_MODULE_1__["default"].firestore().collection("Profiles").doc(coachesList[i].coach).get();
  ...
  componentDidMount() {
    let coachesList = [];
    const callReqRef = _firebase__WEBPACK_IMPORTED_MODULE_1__["default"].firestore().collection("Connections").where("user", "==", this.props.user.uid).get().then(snapShot => {
      snapShot.forEach(doc => {
        const obj = {
          "coach": doc.data().coach,
          "user": doc.data().user,
...
/* harmony import */ var _material_ui_core_DialogTitle__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @material-ui/core/DialogTitle */ "@material-ui/core/DialogTitle");
/* harmony import */ var _material_ui_core_DialogTitle__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core_DialogTitle__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _components_UserConnectionRequests__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/UserConnectionRequests */ "./components/UserConnectionRequests.js");
/* harmony import */ var _components_CoachConnectionRequests__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/CoachConnectionRequests */ "./components/CoachConnectionRequests.js");
...
/* harmony import */ var _components_loggedout__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../components/loggedout */ "./components/loggedout.js");
...
class Connections extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    this.state = {
      "loaded": false,
      ...
      if (this.state.user) {
        if (this.state.profile) {
          if (this.state.isCoach) {
            return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_navbar__WEBPACK_IMPORTED_MODULE_13__["default"], {
...
module.exports = __webpack_require__(/*! C:\Users\santh\WebstormProjects\ExchangeTrain\pages\connections.js */"./pages/connections.js");
